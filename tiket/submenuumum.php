...
if ($date == "Sunday"){
	...
	<div class='w3-display-middleleft' id='feature' >
		<a href='submenuumum.php?act=tdkpraktek' class='w3-black btn btn-lg btn-default wow fadeInUp'>
			<h1 >RAWAT JALAN</h1>
		</a>
	</div>
	";
	...
	echo "
	<div class='w3-display-middleleft' id='feature' >
	<a href='submenuumum.php?act=tutup' class='w3-black btn btn-lg btn-default wow fadeInUp'>
		<h1 >RAWAT JALAN</h1>
	</a>
</div>
";
	...
	echo "
	<div class='w3-display-middleleft' id='feature' >
		<a href='submenuumum.php?act=rajal' class='btn btn-lg btn-default wow fadeInUp'>
		<h1>RAWAT JALAN</h1>
		</a>
	</div>
";
...
<div class="w3-display-middleright" id="feature"> 
	<a href="submenuranapumum.php?act=ranap" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" >
		<h1>RAWAT INAP</h1>
	</a>
</div>
