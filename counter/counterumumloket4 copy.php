...
$callLink = $hasQueue
    ? "counterumumloket4.php?act=call"
    : "counterumumloket4.php?act=default";
?>
...
switch ($act) {
    case "call":
        ...
        $cek = mysqli_query($conn, "SELECT id FROM tbl_bpjs 
                                    WHERE status = 2 AND panggil = 2 AND loket = 4
                                    LIMIT 1");
        ...
        if ($jml === 0) {
            ...
            if ($pgl) {
                ...
                mysqli_query($conn, "UPDATE tbl_bpjs SET panggil = 1, loket = 4 WHERE id = {$id}");
                // reset callback loket 1
                mysqli_query($conn, "UPDATE tbl_bpjs SET panggil = 0, loket = 0 
                                     WHERE status = 2 AND loket = 4");
                ...
                <div id='rajal' style='display: block;'>    
                    ...
                    <div class='w3-display-bottomleft w3-large' style='padding-left:100px; padding-bottom:200px;'>
                        <form method='POST' action='aksi_panggil.php?act=clear&id={$id}&loket=4'>
                    ...
                    <div class='w3-display-bottomleft w3-large' style='padding-bottom:200px;'>
                        <form method='POST' action='aksi_panggil.php?act=hold&id={$id}&loket=4'>
                            <p style='font-size:200%;'>
    ...
    case "callback":
        ...
        if ($no > 0) {
            ...
            if ($pgl) {
                ...
                mysqli_query($conn, "UPDATE tbl_bpjs SET panggil = 2, loket = 4 WHERE id = {$id}");
