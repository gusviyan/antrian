...
$callLink = $hasQueue
    ? "counterumumloket1.php?act=call"
    : "counterumumloket1.php?act=default";
?>
    ...
    case "call":
        ...
        if ($jml === 0) {
            ...
            if ($pgl) {
                ...
                mysqli_query($conn, "UPDATE tbl_umum SET panggil = 1, loket = 1 WHERE id = {$id}");
                ...
                <div id='rajal' style='display: block;'>    
                    ...
                    <div class='w3-display-bottomleft w3-large' style='padding-left:100px; padding-bottom:200px;'>
                        <form method='POST' action='aksi_panggil.php?act=clear&id={$id}&loket=1'>
                    ...
                    <div class='w3-display-bottomleft w3-large' style='padding-bottom:200px;'>
                        <form method='POST' action='aksi_panggil.php?act=hold&id={$id}&loket=1'>
                            <p style='font-size:200%;'>
    ...
    case "callback":
        ...
        if ($no > 0) {
            ...
            if ($pgl) {
                ...
                mysqli_query($conn, "UPDATE tbl_umum SET panggil = 2, loket = 1 WHERE id = {$id}");
